        ...
        >
          {isMobile ? (
                ...
                <div className="w-full h-full bg-black rounded-[47px] p-[10px] relative overflow-hidden">
                  ...
                  <div className="w-full h-full bg-white rounded-[37px] overflow-hidden relative">
                    ...
                    <div className="h-full flex flex-col">
                      {/* Status Bar */}
                      <div className="h-11 flex items-center justify-between px-6 pt-2" style={{ backgroundColor: headerBg }}>
                        <span className="text-sm font-semibold" style={{ color: headerText }}>9:41</span>
                      ...
                      >
                        ...
                        <div className="flex-1">
                          <h3 className="text-base font-semibold" style={{ color: headerText }}>John Doe</h3>
                      ...
                      {/* Home Indicator */}
                      <div className="h-5 flex items-center justify-center" style={{ backgroundColor: theme === "dark" ? "#0b141a" : "#f0f2f5" }}>
            ...
            <div className="w-full h-full rounded-lg border border-gray-300 shadow-xl overflow-hidden">
              ...
              {/* Chat Background */}
              <div 
                className="flex-1 p-4 overflow-y-auto h-[calc(100%-120px)]"
                style={{ 
                  backgroundColor: bgColor,
                  backgroundImage: theme === "dark" 
                    ? 'url("data:image/svg+xml,%3Csvg width=\'100\' height=\'100\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Cpath d=\'M0 0h100v100H0z\' fill=\'%230b141a\'/%3E%3Cpath d=\'M20 10h60M20 30h40M20 50h50M20 70h45M20 90h55\' stroke=\'%23182229\' stroke-width=\'0.5\' fill=\'none\' opacity=\'0.1\'/%3E%3C/svg%3E")'
